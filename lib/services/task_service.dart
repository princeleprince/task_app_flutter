...
class TaskService {
  ...
  Future<void> addTask(Task task) async {
    try {
      // Convertion des DateTime en Timestamp pour Firestore
    ...
    return _getUserTasksRef(userId)
        ...
        .map((snapshot) {
          return snapshot.docs.map((doc) {
            ...
            // Convertir les Timestamp Firestore en DateTime
  ...
  // Optionnel: Méthode pour récupérer les statistiques directement depuis Firestore
  Future<Map<String, int>> getTaskStats(String userId) async {
    try {
      QuerySnapshot snapshot = await _getUserTasksRef(userId).get();
